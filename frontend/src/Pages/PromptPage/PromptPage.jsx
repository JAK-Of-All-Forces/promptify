    ...
    return (
        ...
        <div className="right-side">
            <div className="caption">
                <p>Your vibe, your music, your prompt, make a playlist!</p>
            </div>
            <div className="playlist-prompt-section">
                <div className="playlist-name">
                    <p>Playlist Name: </p>
                    <input type="text" placeholder="Optional" value={inputPlaylistName} onChange={handleOnNameInputChange}/>
                </div>
                <div className="activity-button">
                    <button onClick={toggleActivities}>Choose an Activity</button>
                    <div className={`sidebar ${showActivityInput ? "open" : "closed"}`}>
                        ...
                        {selectedActivity.length > 0 ? (
                            <p>Your selected activity is: {selectedActivity.join(", ")}</p>
                        ) : (
                ...
                <div className="duration-button">
                    ...
                    <div className={`sidebar ${showDurationInput ? "open" : "closed"}`}>
                        ...
                        {selectedDuration.length > 0 ? (
                            <p>Your selected duration is: {selectedDuration.join(", ")}</p>
                        ) : (
                ...
                <div className="bpm-button">
                    ...
                    <div className={`sidebar ${showBPMInput ? "open" : "closed"}`}>
                        <input type="number" placeholder="40" min="40" max="200" value={bpmLow} onChange={handleBPMLowInputChange}/>
                        <input type="number" placeholder="200" min="40" max="200" value={bpmHigh} onChange={handleBPMHighInputChange}/>
                        {bpmLow && bpmHigh ? (
                            <p>Your chosen BPM range is : {bpmLow} to {bpmHigh}.</p>
                        ) : (
                            <>
                                <p>You have not chosen a BPM range.</p>
                                <p>If you are okay with that, please press the PROCEED button, and then press generate playlist.</p>
